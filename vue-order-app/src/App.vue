    ...
    <div v-if="authState != 'signedin'">
      ...
      <div v-if="!storeOpen" >
         ...
         <lottie-animation
            ...
            :loop="false"
        />
          <h3>Das Geschäft ist momentan geschlossen</h3>
      </div>
   ...
   methods:{
    ...
    init(){
          ...
          async deriveToken(){
              ...
              var config = {
                  method: 'post',
                  url: this.$APIGWEndpointValidatorService + 'qr-code?token='+token,
                  headers: {
          ...
          async getConfig () {
            ...
            try {
              ...
              this.menu = data.find(item => item.PK.S === "menu").value.L;
            } catch (err) {
